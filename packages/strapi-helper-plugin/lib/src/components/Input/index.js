...
// import GiveCategorySelect from '../custom-components/select-category';
import MultiImageInput from '../custom-components/multi-image-input';
import LocationInput from '../custom-components/location-input';
import Wysiwyg from '../custom-components/html-input';
import IconSelect from '../custom-components/select-icon';
import SingleImageInput from '../custom-components/single-image-input';
import ModelSelectorInput from '../custom-components/model-selector';
...
class Input extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  componentDidCatch(error, errorInfo) {
        ...
        console.log('Component error here',error)
        console.log('Component error info here',errorInfo)
  }
  ...
  renderOrganisationSelector = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
              ...
              <FormattedMessage id={this.props.placeholder || this.props.label}>
                  {(placeholder) => (
                      <ModelSelectorInput
                          ...
                          modelUrl={`${window.location.protocol}//${window.location.hostname}:1337/organisation`}
                          className={`form-control ${!this.props.deactivateErrorHighlight && !isEmpty(this.state.errors) ? 'is-invalid': ''}`}
  ...
  renderCategorySelector = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
              ...
              <FormattedMessage id={this.props.placeholder || this.props.label}>
                  {(placeholder) => (
                      <ModelSelectorInput
                          ...
                          modelUrl={`${window.location.protocol}//${window.location.hostname}:1337/category`}
                          className={`form-control ${!this.props.deactivateErrorHighlight && !isEmpty(this.state.errors) ? 'is-invalid': ''}`}
                          label={`${this.props.label}`}
                          value={this.props.value}
                          tabIndex={this.props.tabIndex}
  ...
  renderIconSelect = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
  ...
  renderLocationInput = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
  ...
  renderSingleImageInput = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
  ...
  renderMultiImageInput = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
  ...
  renderWysiwyg = (requiredClass, inputDescription, handleBlur) => {
        let spacer = !isEmpty(this.props.inputDescription) ? <div className={styles.spacer} /> : <div />;
    ...
    switch (this.props.type) {
            case 'icon-select':
                return this.renderIconSelect(requiredClass, inputDescription, handleBlur);
            case 'cat-select':
                return this.renderCategorySelector(requiredClass, inputDescription, handleBlur);
            case 'org-select':
                return this.renderOrganisationSelector(requiredClass, inputDescription, handleBlur);
            case 'wysiwyg':
                return this.renderWysiwyg(requiredClass, inputDescription, handleBlur);
            case 'location':
                return this.renderLocationInput(requiredClass, inputDescription, handleBlur);
            case 'multi-image':
                return this.renderMultiImageInput(requiredClass, inputDescription, handleBlur);
            case 'single-image':
                return this.renderSingleImageInput(requiredClass, inputDescription, handleBlur);

            /**case 'selectoptions':
                return this.renderGiveSelectCategory(requiredClass, inputDescription, handleBlur);
             **/
            case 'select':
