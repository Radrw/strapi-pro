...
module.exports = {
  ...
  add: async (values) => {
    ...
    await strapi.hook.mongoose.manageRelations('category', _.merge(_.clone(data), { values }));
    return data;
  },
  ...
  edit: async (params, values) => {
    ...
    await strapi.hook.mongoose.manageRelations('category', _.merge(_.clone(params), { values }));
